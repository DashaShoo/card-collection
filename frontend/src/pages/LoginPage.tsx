...
export default function LoginPage() {
  ...
  return (
    <div className="text-white min-h-screen bg-gray-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-white">
            Card<span className="text-orange-400">Collect</span>
          </h1>
          <p className="text-gray-400 mt-2">Войдите в свою коллекцию</p>
        </div>
        ...
        >
          <h2 className="text-white text-xl font-semibold">Вход</h2>
